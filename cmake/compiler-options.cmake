...
set (WARNING_OPTIONS "-Werror -Wpedantic -Wall -Wextra -Wmissing-declarations -Wconversion -Wshadow -Wfloat-equal")
...
set (DEBUG_OPT_OPTIONS "${COMMON_OPT_OPTIONS} -O0 -fprofile-arcs -ftest-coverage")
set (RELEASE_OPT_OPTIONS "${COMMON_OPT_OPTIONS} -Os -flto=auto")
...
# Common arguments
set(COMMON_OPTIONS "${WARNING_OPTIONS} ${ARM_OPTIONS} ${DIAGMSG_OPTIONS}")
...
# Release flags
set(COMMON_RELEASE_FLAGS "${RELEASE_OPT_OPTIONS} -DNDEBUG=1 -DRELEASE=1")
